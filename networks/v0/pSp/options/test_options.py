...
class TestOptions:
	...
	def initialize(self):
		...
		# arguments for dilating images
		self.parser.add_argument('-s', '--size', type=int, default=2048)
		self.parser.add_argument('-i', '--input', type=str, default='m.jpg')
		self.parser.add_argument('-o', '--output', type=str, default='mm.jpg')
		self.parser.add_argument('-f', '--folder', type=str, default='no')
		self.parser.add_argument('-od', '--outdir', type=str, default='./colored_mesh')
		self.parser.add_argument('-m', '--is_mask', type=bool, default=True)
		self.parser.add_argument('-q', '--is_quad', type=bool, default=True)
		self.parser.add_argument('-obj', '--test_mesh_path', type=str, default='/home/shengcai/process/wild_challenge/res50_wild_3d_mix/output_results/res50_wild_3d_balanced_wild/')
