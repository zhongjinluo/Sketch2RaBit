...
class Sketch2TextureStyle:
    def __init__(self):
        ...
        test_opts.checkpoint_path = "/program/huawei/something/pSp/out/render_masked/checkpoints/best_model_render_masked.pt"
...
if __name__ == '__main__':
    ...
    for f in os.listdir("/program/huawei/something/datasets/render_masked_test/"):
        ...
        image.save("out/render_masked/inference_results/" + f.replace(".png", "_i.png"))
        image = s2ts.predict(image)
        image.save("out/render_masked/inference_results/" + f.replace(".png", "_xj.png"))
        print(f)
